...
public class Colecciones {
    ...
    public static void ejemploHashMap() {
        ...
        diccClientes.put("d4", new Cliente(7, "Jorge","jorge@email.com"));
        Map<Date, Cliente> mapClientesFecha = new TreeMap<Date, Cliente>();
        mapClientesFecha.put(new Date(82, 4, 9), luis);
        mapClientesFecha.put(new Date(92, 9, 23), new Cliente(8,"Jose","jose@jj"));
        mapClientesFecha.put(new Date(117, 8, 30), new Cliente(9,"Maria","maria@mm"));
